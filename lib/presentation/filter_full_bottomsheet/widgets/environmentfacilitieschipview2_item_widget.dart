...
class Environmentfacilitieschipview2ItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return RawChip(
      ...
      label: Text(
        environmentfacilitieschipview2ItemModelObj.buttonCategory!,
        style: TextStyle(
      ...
      selected:
          (environmentfacilitieschipview2ItemModelObj.isSelected ?? false),
      backgroundColor: appTheme.gray100,
      selectedColor: appTheme.gray100,
      shape: (environmentfacilitieschipview2ItemModelObj.isSelected ?? false)
