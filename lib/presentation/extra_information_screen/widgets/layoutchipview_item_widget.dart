...
class LayoutchipviewItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return RawChip(
      ...
      label: Text(
        layoutchipviewItemModelObj.buttonCategory!,
        style: TextStyle(
          color: (layoutchipviewItemModelObj.isSelected ?? false)
      ...
      selected: (layoutchipviewItemModelObj.isSelected ?? false),
      backgroundColor: theme.colorScheme.primary,
      selectedColor: appTheme.gray100,
      shape: (layoutchipviewItemModelObj.isSelected ?? false)
